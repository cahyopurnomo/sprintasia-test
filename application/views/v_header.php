...
<head>
  ...
  <link href="<?php echo base_url() ?>assets/css/select2/select2-bootstrap4.css" rel="stylesheet">
  <style>
  ...
  <div class="container">
    ...
    <div id="navbarSupportedContent" class="collapse navbar-collapse">
      <ul class="navbar-nav ml-auto">
        <li class="nav-item active"><a href="<?php echo base_url(); ?>" class="nav-link">Home <span class="sr-only">(current)</span></a></li>
